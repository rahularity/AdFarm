...
public class OtpAuth extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView mResend,mStart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() != null){
                    ...
                    Intent i=new Intent(OtpAuth.this,UserSelectionActivity.class);
                    startActivity(i);
                    finish();
                }
            }
        ...
        mStart = (TextView) findViewById(R.id.button_start_verification);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_verify_phone:
                ...
                break;
            case R.id.resend:
                resendVerificationCode(mPhoneNumberField.getText().
                        toString(), mResendToken);
                break;
        }
    }
}
